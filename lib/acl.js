...
Acl.prototype.middleware = function(numPathComponents, userId, actions){
  contract(arguments)
    ...
    .params('number|string','string|number|function')
    .params('number|string','string|number|function', 'string|array')
    .end();
  ...
  return function(req, res, next){
    ...
    if(!numPathComponents){
      ...
      if(typeof numPathComponents === 'string'){
        resource = numPathComponents;
      }else {
